...
var host = "34.82.151.243";    //from GCloud instance (change to match your db)
var database = "cheesecakedb";  //database name
var user = "root";         //username (change to match your db)
var password = "foodnestturtle";  //password (change to match your db, yes this is very poor practice)
